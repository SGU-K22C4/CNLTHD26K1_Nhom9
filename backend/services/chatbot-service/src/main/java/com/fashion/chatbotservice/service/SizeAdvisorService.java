...
public class SizeAdvisorService {
    ...
    public record Measurements(Integer heightCm, Integer weightKg, Integer chestCm, Integer waistCm, Integer hipCm) {
    ...
    public record SizeResult(String recommendedSize, String note) {}

    public enum GarmentType { TOP, BOTTOM }

    /**
     * Trích xuất số đo từ tin nhắn tiếng Việt.
     * Ưu tiên parse HEIGHT_M (1m65) trước HEIGHT_CM (165cm) để tránh nhầm lẫn.
     */
